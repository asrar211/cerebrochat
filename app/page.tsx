...
export default function Home() {
  return (
    <div className="h-dvh">
      <nav className="flex mt-4 mx-2 xl:max-w-7xl xl:mx-auto justify-between items-center bg-neutral-300/50 rounded-full text-black p-4">
      ...
      <div className="grid xl:grid-cols-2 grid-cols-1 xl:max-w-7xl xl:mx-auto mx-2">
          <div className="flex flex-col mt-10">
            ...
            <h1 className="mt-10 text-5xl text-center font-semibold text-green-600 leading-14">Empathetic <br/>Mental Health <br/><span className="text-green-800">Chatbot</span></h1>
      ...
      <div className="flex justify-center items-center mx-2 text-center mt-10">
